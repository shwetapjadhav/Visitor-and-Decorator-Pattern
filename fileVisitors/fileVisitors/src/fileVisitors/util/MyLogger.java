...
public class MyLogger{
    ...
    /*DEBUG_VALUE=4 [Print to stdout everytime a constructor is called]
      DEBUG_VALUE=3 [Print to stdout everytime the node is created]
    ...
    */
    ...
    public static enum DebugLevel {RELEASE, FROM_RESULTS, IN_RESULTS, NODE_CREATE, CONSTRUCTOR
                                   };
	...
	switch (levelIn) {
		...
		case 3: debugLevel = DebugLevel.NODE_CREATE; break;
